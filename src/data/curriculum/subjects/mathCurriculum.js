...
const mathCurriculum = [
  // ===== 小一 (P1, Level 1) =====
  { grade: 'p1', curriculumLevel: 1, domain: '數', strand: 'N1', topic: '100以內數數', edbRef: 'N1-1',
    learningObjectives: ['認識1-100的數字', '掌握順數和倒數', '認識奇數和偶數'] },
  { grade: 'p1', curriculumLevel: 1, domain: '數', strand: 'N1', topic: '加法概念', edbRef: 'N1-2',
    learningObjectives: ['理解加法意義', '20以內加法', '認識加法交換性質'] },
  { grade: 'p1', curriculumLevel: 1, domain: '數', strand: 'N1', topic: '減法概念', edbRef: 'N1-3',
  ...
  // ===== 小二 (P2, Level 2) =====
  { grade: 'p2', curriculumLevel: 2, domain: '數', strand: 'N2', topic: '四位數', edbRef: 'N2-1',
    learningObjectives: ['認識0-10000', '位值概念（個十百千）', '數的比較和排序'] },
  { grade: 'p2', curriculumLevel: 2, domain: '數', strand: 'N2', topic: '加減法(二)', edbRef: 'N2-2',
    learningObjectives: ['兩位數加減', '三位數加減', '進位和退位'] },
  { grade: 'p2', curriculumLevel: 2, domain: '數', strand: 'N2', topic: '乘法概念', edbRef: 'N2-3',
    learningObjectives: ['理解乘法意義', '2,5,10的乘法口訣', '乘法應用題'] },
  { grade: 'p2', curriculumLevel: 2, domain: '數', strand: 'N2', topic: '除法概念', edbRef: 'N2-4',
  ...
  // ===== 小三 (P3, Level 3) =====
  { grade: 'p3', curriculumLevel: 3, domain: '數', strand: 'N3', topic: '萬以內加減', edbRef: 'N3-1',
    learningObjectives: ['四位數加減', '加減混合運算', '應用題'] },
  { grade: 'p3', curriculumLevel: 3, domain: '數', strand: 'N3', topic: '乘法(二)', edbRef: 'N3-2',
    learningObjectives: ['3,4,6,7,8,9的乘法口訣', '兩位數乘一位數'] },
  { grade: 'p3', curriculumLevel: 3, domain: '數', strand: 'N3', topic: '除法(二)', edbRef: 'N3-3',
    learningObjectives: ['兩位數除以一位數', '有餘數的除法', '整除性'] },
  { grade: 'p3', curriculumLevel: 3, domain: '數', strand: 'N3', topic: '分數初步', edbRef: 'N3-4',
  ...
  // ===== 小四 (P4, Level 4) =====
  { grade: 'p4', curriculumLevel: 4, domain: '數', strand: 'N4', topic: '多位數', edbRef: 'N4-1',
    learningObjectives: ['認識大數（萬以上）', '數的估算', '四捨五入'] },
  { grade: 'p4', curriculumLevel: 4, domain: '數', strand: 'N4', topic: '乘除法(三)', edbRef: 'N4-2',
    learningObjectives: ['三位數乘一位數', '兩位數除法', '乘除混合運算'] },
  { grade: 'p4', curriculumLevel: 4, domain: '數', strand: 'N4', topic: '分數(二)', edbRef: 'N4-3',
    learningObjectives: ['假分數和帶分數', '擴分和約分', '異分母比較'] },
  { grade: 'p4', curriculumLevel: 4, domain: '數', strand: 'N4', topic: '小數', edbRef: 'N4-4',
  ...
  // ===== 小五 (P5, Level 5) =====
  { grade: 'p5', curriculumLevel: 5, domain: '數', strand: 'N5', topic: '分數(三)', edbRef: 'N5-1',
    learningObjectives: ['異分母加減', '分數乘法', '分數除法'] },
  { grade: 'p5', curriculumLevel: 5, domain: '數', strand: 'N5', topic: '小數(二)', edbRef: 'N5-2',
    learningObjectives: ['三位小數', '小數乘法', '小數除法'] },
  { grade: 'p5', curriculumLevel: 5, domain: '數', strand: 'N5', topic: '百分數', edbRef: 'N5-3',
  ...
  // ===== 小六 (P6, Level 6) =====
  { grade: 'p6', curriculumLevel: 6, domain: '數', strand: 'N6', topic: '小數和分數混合', edbRef: 'N6-1',
    learningObjectives: ['混合四則運算', '應用題解難'] },
  { grade: 'p6', curriculumLevel: 6, domain: '數', strand: 'N6', topic: '百分數(二)', edbRef: 'N6-2',
    learningObjectives: ['折扣和盈利', '稅務和利率', '百分數應用題'] },
  { grade: 'p6', curriculumLevel: 6, domain: '數', strand: 'N6', topic: '比和率', edbRef: 'N6-3',
